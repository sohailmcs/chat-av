...
$(function() {
    ...
    $("#frmforgotpwd").submit(function(e) {
        ...
        var url =
            ...
            encodeURIComponent($("#txtEmailPhone").val()) + "&UserType=Patient" +
            ...
            error: function(xhr, textStatus, err) {
                if (xhr.status == "500" && xhr.statusText == "InternalServerError")
                    ...
                    Swal.fire({
                        type: "error",
                        title: "Oops...",
                        html: "User doest not exist <br> <b >" +
                            $("#txtEmailPhone").val() +
                            "</b><br> ",
                    });
                }
    ...
    $("#frmresetpwd").submit(function(e) {
        ...
        if (username == "") {
            Swal.fire({
                type: "info",
                title: "SORRY!",
                html: "Please enter valid username. <br> <b >" +
                    $("#txtUsername").val() +
                    "</b><br> ",
            });
            return false;
        ...
        if (password != confirmPassword) {
            Swal.fire({
                type: "error",
                title: "SORRY!...",
                html: "Passwords do not match. <br> <b >" +
                    $("#txtOldPassword").val() +
                    "=" +
                    $("#txtNewPassword").val() +
                    "</b><br> ",
            ...
            error: function(xhr, textStatus, err) {
                if (xhr.status == "500" && xhr.statusText == "InternalServerError") {
                    ...
                    Swal.fire({
                        type: "error",
                        title: "SORRY!",
                        html: "username or current password does not exist in our system <br> <b >" +
                            $("#txtUsername").val() +
                            "</b><br> ",
                    });
                }
