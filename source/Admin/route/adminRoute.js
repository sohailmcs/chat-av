...
let adminController = require(appRoot+'/source/Admin/controller/adminController');
...
router.get('/create-doctor',  AdminController.getkindahCreateDoctor.bind(AdminController)); 
router.get('/all-doctors',  AdminController.getkindahGetAllDoctors.bind(AdminController)); 
router.get('/edit-profile',  AdminController.getDoctorEditProfile.bind(AdminController)); 
