...
class defaultController {
    ...
    async getKindahManageFAQS(req, res, next) {
        res.render(appRoot + "/source/Admin/view/KindahGetAllFAQS", {
            pageTitle: "Kindah FAQS",
            userName: req.session.userName,
            userId: req.session.userId,
            roleId: req.session.roleId
        });
    ...
    async getKindahAEditddFAQS(req, res, next) {
        res.render(appRoot + "/source/Admin/view/KindahAddEditFAQ", {
            pageTitle: "Kindah FAQS",
            userName: req.session.userName,
            userId: req.session.userId,
            roleId: req.session.roleId
